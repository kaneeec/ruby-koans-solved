...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # >>> use __send__ if send clashes with another method name
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # >>> we would replace the default behavior (USE WITH CAUTION)
    # >>> also note that without replacing respond_to? too, you break it
    # >>> handy when we want to create a proxy to our class
